...
(async () => {
    ...
    if (language_storage === "english") {
        ...
        if (english_checkbox && french_checkbox && portuguese_checkbox && spanish_checkbox && title && settings_p && no_wait_text) {
            ...
            (portuguese_checkbox.parentElement?.lastElementChild).textContent = "Portuguese";
            (spanish_checkbox.parentElement?.lastElementChild).textContent = "Spanish";
        ...
        if (english_checkbox && french_checkbox && portuguese_checkbox && spanish_checkbox && title && settings_p) {
            ...
            (french_checkbox.parentElement?.lastElementChild).textContent = "Francês";
            (portuguese_checkbox.parentElement?.lastElementChild).textContent = "Português";
            (spanish_checkbox.parentElement?.lastElementChild).textContent = "Espanol";
        ...
        if (english_checkbox && french_checkbox && portuguese_checkbox && spanish_checkbox && title && settings_p) {
            ...
            (portuguese_checkbox.parentElement?.lastElementChild).textContent = "Portugués";
            (spanish_checkbox.parentElement?.lastElementChild).textContent = "Español";
        ...
        if (english_checkbox && french_checkbox && portuguese_checkbox && spanish_checkbox && title && settings_p) {
            ...
            (portuguese_checkbox.parentElement?.lastElementChild).textContent = "Portugais";
            (spanish_checkbox.parentElement?.lastElementChild).textContent = "Espagnol";
    ...
    if (facebook === false) {
        social_media_sites = social_media_sites.filter(item => item !== "facebook.com");
    }
    if (tiktok === false) {
        social_media_sites = social_media_sites.filter(item => item !== "tiktok.com");
    }
    if (reddit === false) {
        social_media_sites = social_media_sites.filter(item => item !== "reddit.com");
    }
    if (youtube === false) {
        social_media_sites = social_media_sites.filter(item => item !== "youtube.com");
    }
    if (twitch === false) {
        social_media_sites = social_media_sites.filter(item => item !== "twitch.tv");
    }
    if (x === false) {
        social_media_sites = social_media_sites.filter(item => item !== "x.com" && item !== "twitter.com");
    }
    if (whatsapp === false) {
        social_media_sites = social_media_sites.filter(item => item !== "web.whatsapp.com");
    }
    if (messenger === false) {
        social_media_sites = social_media_sites.filter(item => item !== "messenger.com");
    }
    if (telegram === false) {
        social_media_sites = social_media_sites.filter(item => item !== "web.telegram.org");
    }
    if (discord === false) {
        social_media_sites = social_media_sites.filter(item => item !== "discord.com");
    }
    if (linkedin === false) {
        social_media_sites = social_media_sites.filter(item => item !== "linkedin.com");
    }
    if (snapchat === false) {
        social_media_sites = social_media_sites.filter(item => item !== "snapchat.com");
    }
    if (pinterest === false) {
        social_media_sites = social_media_sites.filter(item => item !== "pinterest.com");
    }
    if (threads === false) {
        social_media_sites = social_media_sites.filter(item => item !== "threads.net");
    }
    if (bluesky === false) {
        social_media_sites = social_media_sites.filter(item => item !== "bsky.app");
    }
    if (mastodon === false) {
        social_media_sites = social_media_sites.filter(item => item !== "mastodon.social" &&
    ...
    if (img_folder === 0) {
        cat_number = (Math.floor(Math.random() * 5)) + 1;
    }
